 ...
 */
$calColorBgDark      = '#000';	// 枠、曜日の背景dark background color
$calColorTextOnDark  = '#fff';	// 曜日の文字text appearing on top of dark bg color
$calColorBgLight     = '#aaa';	// 数字背景light background color
$calColorTextOnLight = '#fff';	// 数字色text appearing on top of light bg color
$calColorBgToday     = '#ddd';	// 今日の日付を示す色background color for "today" box
